...
const float DEFAULT_AVATAR_SUPPORT_BASE_LEFT  = -0.25;
const float DEFAULT_AVATAR_SUPPORT_BASE_RIGHT =  0.25;
const float DEFAULT_AVATAR_SUPPORT_BASE_FRONT = -0.10;
const float DEFAULT_AVATAR_SUPPORT_BASE_BACK  =  0.17;
