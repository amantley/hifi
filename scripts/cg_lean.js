...
function messageHandler(channel, messageString, senderID) {
	...
	//print("quat " + hipquat.x + " " + hipquat.y + " " + hipquat.z + " " + hipquat.w);
...
var testhips = {x:0.0,y:0.0,z:0.0,w:1.0};
...
function update(dt) {
	...
	var oldxaxiships = Vec3.normalize( Vec3.multiplyQbyV( armsHipRotation,xaxis   ) );
	var oldyaxiships = Vec3.normalize( Vec3.multiplyQbyV( armsHipRotation,yaxis   ) );
	...
	//print("new y axis " + newy_axis_hips.x +" " +newy_axis_hips.y + " "+ newy_axis_hips.z);
	//print("old z axis " + oldzaxiships.x +" " +oldzaxiships.y + " "+ oldzaxiships.z);
	...
	//print("left " + left.x +" " + left.y + " "+ left.z);
	//print("up " + up.x +" " + up.y + " "+ up.z);
	//print("view " + view.x +" " + view.y + " "+ view.z);
	...
	var ROT_X90 = {x:0.7071,y:0,z:0,w:0.7071};
	var rottest1 = Quat.multiply(ROT_Y180,ROT_X90);
	var rottest2 = Quat.multiply(ROT_X90,ROT_Y180);
	
	hipsRotation = Quat.multiply( ROT_Y180,finalrot);
	//print(" beforehips " + beforehips.x + " " + beforehips.y + " " + beforehips.z + " " + beforehips.w );
	//print(" final rot " + finalrot.x + " " + finalrot.y + " " + finalrot.z + " " + finalrot.w );
	//print("hipRotation final " + hipsRotation.x + " " + hipsRotation.y + " " + hipsRotation.z + " " + hipsRotation.w );
	
	//print(" rottest1 " + rottest1.x + " " + rottest1.y + " " + rottest1.z + " " + rottest1.w );
	//print(" rottest2 " + rottest2.x + " " + rottest2.y + " " + rottest2.z + " " + rottest2.w );
